...
class View implements ArrayAccess, Htmlable, ViewContract
{
    ...
    /**
     * Get the sections of the rendered views.
     *
     * @return array
     *
     * @throws \Throwable
    ...
    /**
     * Add a views instance to the views data.
     *
     * @param  string  $key
     * @param  string  $view
     * @param  array  $data
    ...
    /**
     * Add validation errors to the views.
     *
    ...
    /**
     * Get the path to the views file.
     *
     * @return string
     */
    ...
    /**
     * Get the views's rendering engine.
     *
    ...
    /**
     * Get a piece of bound data to the views.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    /**
     * Set a piece of data on the views.
     *
     * @param  string  $key
     * @param  mixed  $value
     * @return void
    ...
    /**
     * Unset a piece of data from the views.
     *
     * @param  string  $key
     * @return void
     */
    ...
    /**
     * Get a piece of data from the views.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    /**
     * Check if a piece of data is bound to the views.
     *
     * @param  string  $key
     * @return bool
     */
    ...
    /**
     * Remove a piece of bound data from the views.
     *
     * @param  string  $key
     * @return void
     */
    ...
    /**
     * Dynamically bind parameters to the views.
     *
     * @param  string  $method
