...
trait ManagesEvents
{
    ...
    /**
     * Add an event for a given views.
     *
     * @param  string  $view
     * @param  \Closure|string  $callback
     * @param  string  $prefix
    ...
    /**
     * Register a class based views composer.
     *
     * @param  string  $view
     * @param  string  $class
     * @param  string  $prefix
    ...
    protected function addClassEvent($view, $class, $prefix)
    {
        ...
        // When registering a class based views "composer", we will simply resolve the
        // classes from the application IoC container then call the compose method
        // on the instance. This allows for convenient, testable views composers.
