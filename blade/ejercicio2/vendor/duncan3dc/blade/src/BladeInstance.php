...
class BladeInstance implements BladeInterface
{
    ...
    /**
     * Create a new instance of the blade views factory.
     *
    ...
    /**
     * Check if a views exists.
     *
     * @param string $view The name of the views to check
     *
     * @return bool
     */
     ...
     * @param array $data The parameters to pass to the views
     * @param array $mergeData The extra data to merge
     *
     * @return ViewInterface The generated views
     */
     ...
     * Generate a views.
     *
     * @param string $view The name of the views to make
     * @param array $params The parameters to pass to the views
     * @param array $mergeData The extra data to merge
     *
     * @return ViewInterface The generated views
     */
    ...
    /**
     * Get the content by generating a views.
     *
     * @param string $view The name of the views to make
     * @param array $params The parameters to pass to the views
     *
